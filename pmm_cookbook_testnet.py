#!/usr/bin/env python3
"""
Pythagorean Market Maker (PMM) Cookbook - Enhanced Version
Complete guide for interacting with PMM on Base Sepolia

Contract Addresses (deployed 2025-06-20):
- PythagoreanMarketMaker: 0xd37263E22862f36aB23427D33667e10AE1Fe3648
- MockUSDC: 0x37f48aE1ccc86c221C743318FdE68507bFF19319
...
PMM_ADDRESS = "0xd37263E22862f36aB23427D33667e10AE1Fe3648"
MOCK_USDC_ADDRESS = "0x37f48aE1ccc86c221C743318FdE68507bFF19319"
PMM_ABI = [
    {
        "inputs": [
...
class PMM_Cookbook:
    ...
    def __init__(self, private_key: Optional[str] = None):
        ...
        self.usdc = self.w3.eth.contract(address=MOCK_USDC_ADDRESS, abi=USDC_ABI)
    ...
    def mint_test_usdc(self, amount_usdc: float) -> str:
        ...
        tx = self.usdc.functions.mint(self.account.address, amount).build_transaction(
            {
                "from": self.account.address,
                "nonce": self.w3.eth.get_transaction_count(self.account.address),
                "gas": 100000,
        ...
        print(f"Minted {amount_usdc} USDC in block {receipt['blockNumber']}")
