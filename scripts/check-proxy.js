...
const IMPLEMENTATION_ADDRESS = process.env.PMM_IMPLEMENTATION_ADDRESS;
...
async function main() {
  ...
  if (!PROXY_ADDRESS || !IMPLEMENTATION_ADDRESS) {
    console.error("❌ ERROR: PMM_PROXY_ADDRESS and PMM_IMPLEMENTATION_ADDRESS are required");
    process.exit(1);
  }
  ...
  console.log("Stored implementation address:", implAddress);
